...
import { createPostAction } from "../actions/post"; // Ajusta tu ruta

export default function CrearPublicacionForm() {
  ...
  async function handleSubmit(formData: FormData) {
    ...
    if (result.success) {
      ...
      // Aquí podrías limpiar el formulario o cerrar un modal
    } else {
      setMensaje(result.error || "Ocurrió un error");
    }
  }
