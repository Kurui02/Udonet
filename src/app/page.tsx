...
import { getLinkMetadata } from "@/modules/posts/actions/links";
...
export default function Home() {
  // Estado para la navegación de hilos
  const [hiloSeleccionado, setHiloSeleccionado] = useState<string | null>(null);

  // Estados para el formulario de publicación con vista previa de enlaces
    ...
    <main style={{ backgroundColor: '#13161b', minHeight: '100vh', padding: '10px' }}>
      <div style={{ maxWidth: '1000px', margin: '0 auto', backgroundColor: '#1e1e1e', minHeight: '90vh', borderRadius: '8px', padding: '20px' }} className="space-y-6">
        ...
        {hiloSeleccionado ? ( 
          ...
          <>
            {/* 1. El Buscador va arriba */}
            <Buscador 
              onSeleccionarPost={abrirHilo}
            />

            {/* 2. El Formulario de publicación va abajo del Buscador */}
